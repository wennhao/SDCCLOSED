...
y_norm = 500
x_norm = 575 #standaard positie van de lijn bij y=500
...
def detect_lanes(path):
    ...
    while True:
        ...
        if x_at_target_values:
            ...
            if x_at_target < x_norm - 50: #voorbeeld waardes
                print("steer left")
            elif x_at_target > x_norm + 50: #voorbeeld waardes
                print("steer right")
...
path = 'C:/Vakken/Jaar 2/Project 78 (SDC)/data/50pdemo/output_video.mp4'
detect_lanes(path)